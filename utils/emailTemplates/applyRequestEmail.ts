interface SendApprovalEmailType extends SendApprovalFunctionEventType {
  approveUrl: string;
  rejectUrl: string;
}

export function sendApprovalEmail({leaveId, userName, userEmail, approveUrl, rejectUrl, startDate, endDate, reason}: SendApprovalEmailType) {
  return (
     `<!DOCTYPE html>
        <html>
        <head>
