interface generateApprovalMailType extends LeaveApprovalEvent {
  adminEmail: string
}

export function generateApprovalEmail({leaveId, adminEmail, userName, leaveStartDate, leaveEndDate, reason}: generateApprovalMailType) {
  return `<!DOCTYPE html>
     <html>
      <head>
        <meta charset="utf-8">
      ...
      <body style="margin: 0; padding: 0; min-width: 100%; background-color: #f5f8fb; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; font-family: Arial, sans-serif; line-height: 24px; color: #333333; font-size: 16px;">
        <div style="display: none; font-size: 1px; color: #f5f8fb; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">
          Good news! Your leave request from ${leaveStartDate} to ${leaveEndDate} has been approved.
        </div>
                ...
                <tr>
                  <td bgcolor="#0047ab" align="center" style="background-color: #0047ab; background-image: linear-gradient(to right, #0047ab, #1e90ff); padding: 30px 20px; text-align: center;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td align="center">
                          <table cellpadding="0" cellspacing="0" border="0" style="width: 80px; height: 80px; margin-bottom: 20px; border-radius: 50%; background-color: #25bd59; box-shadow: 0 4px 8px rgba(0,0,0,0.2);">
                            <tr>
                              <td align="center" valign="middle" style="padding: 15px;">
                                <img src="https://lh7-rt.googleusercontent.com/docsz/AD_4nXfSLjJrK9dyI94flaHgfa17r3VGGGe4Z6R4c4ZWWEkogYJ0ml-9o26zj8o9ikGCYZkI-r0PIK0KiB71TdXSmGkskSSBnQNnckdm25qXoVHag03D0cymD_WE16LsPjPUKWwLfZ6pTQ?key=CTtMt9eN0RMHkXyz1NpkjA" width="40" height="40" alt="Approved icon" style="display: block; border: 0; outline: none; text-decoration: none;">
                              </td>
                            </tr>
                          </table>
                        </td>
                      ...
                      <tr>
                        <td align="center">
                          <h1 style="margin: 0; color: #ffffff; font-size: 26px; font-weight: bold; font-family: Arial, sans-serif; line-height: 36px;">LEAVE REQUEST APPROVED</h1>
                          <p style="margin: 10px 0 0; color: rgba(255, 255, 255, 0.85); font-size: 16px; font-family: Arial, sans-serif;">Your time off has been approved</p>
                        </td>
                      </tr>
                    </table>
                  </td>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td style="padding-bottom: 30px;">
                          <h2 style="margin: 0; color: #25bd59; font-size: 24px; font-weight: bold; font-family: Arial, sans-serif; line-height: 30px; text-align: center;">Great News!</h2>
                          <div style="height: 3px; width: 60px; background-color: #25bd59; margin: 15px auto 0;"></div>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding-bottom: 20px;">
                          <p style="margin: 0; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; color: #333333; text-align: center;">Hi ${userName}, your leave request has been <strong style="color: #25bd59;">approved</strong> by ${adminEmail}.</p>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 25px; background-color: #f0fff4; border-left: 4px solid #25bd59; border-radius: 8px; margin-bottom: 30px;">
                          <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                              <td style="padding-bottom: 15px;">
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                  <tr>
                                    <td width="130" style="color: #25bd59; font-weight: bold; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px;">Request ID:</td>
                            ...
                            <tr>
                              <td style="padding-bottom: 15px;">
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                  <tr>
                                    <td width="130" style="color: #25bd59; font-weight: bold; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px;">Period:</td>
                            ...
                            <tr>
                              <td>
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                  <tr>
                                    <td width="130" style="color: #25bd59; font-weight: bold; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px;">Reason:</td>
                      ...
                      <tr>
                        <td style="padding: 20px; background-color: #f8f9fa; border-left: 3px solid #718096; border-radius: 8px;">
                          <p style="margin: 0; font-family: Arial, sans-serif; font-size: 15px; line-height: 24px; color: #333333;"><strong>Note:</strong> Make sure to complete any pending tasks and set up appropriate hand-offs before your leave begins. Enjoy your time off!</p>
                        </td>
                      </tr>
                    </table>
                  </td>
