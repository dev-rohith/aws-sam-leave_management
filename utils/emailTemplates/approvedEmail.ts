                ...
                <tr>
                  <td bgcolor="#0047ab" align="center" style="background-color: #0047ab; background-image: linear-gradient(to right, #0047ab, #1e90ff); padding: 30px 20px; text-align: center;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td align="center">
                          <table cellpadding="0" cellspacing="0" border="0" style="width: 80px; height: 40px; margin-bottom: 20px; border-radius: 50%; background-color: #25bd59; box-shadow: 0 4px 8px rgba(0,0,0,0.2);">
                          </table>
                        </td>
                      </tr>
                      <tr>
